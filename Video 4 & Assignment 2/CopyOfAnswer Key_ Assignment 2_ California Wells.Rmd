...
```{r}
ca_wells_plot <- ca_wells_final %>% 
  filter(site_id %in% c("340535117573501", "343613120164501"))
```
...
ggplot(data = ca_wells_plot, 
  ...
  scale_color_viridis(discrete = TRUE) +
   ggtitle("Long-term Well Records in California") +
    theme_light() +
  labs(color = "Well Site ID", y= "Feet below land surface (ft)", x = "Year")

ggsave("example_wells.jpg", width = 7.29, height = 4.5, units = "in")
